...
import { verifyTokenTimeout, checkAdminPermission } from "@middlewares/auth/auth.middleware.js";
...
bundled_router.use("/states", verifyTokenTimeout, checkAdminPermission, model_status_router);
